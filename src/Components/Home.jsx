...
const Home = () => {
  ...
  return (
    <section className="min-h-screen bg-slate-950 text-white flex items-center">
      ...
      {/* Main Container */}
      <div className="max-w-6xl mx-auto w-full px-5 py-24 flex flex-col gap-10 md:flex-row md:items-center md:justify-between">
        ...
        <div className="w-full flex justify-center md:w-1/2">
          ...
          <img
            src={ManojPic}
            alt="Manoj"
            className="w-full max-w-xs rounded-2xl object-cover sm:max-w-sm md:max-w-md"
          />
